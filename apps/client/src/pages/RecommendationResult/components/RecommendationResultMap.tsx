...
import {
  ...
  useRecommendationResultUiContext,
} from "../wrappers/RecommendationResult.ui.context";
import { S } from "./RecommendationResultMap.styled";
...
const toKakaoLatLng = ({ lat, lng }: RecommendationResultMapCenter) => {
  return new kakao.maps.LatLng(lat, lng);
};

export default RecommendationResultMap;
